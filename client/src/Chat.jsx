  ...
  return (
    <>
      <div className="flex h-screen">
        <div className="bg-white-100 w-1/3 p-2 flex flex-col">
...
{Object.keys(offlinePeople).map(userId => (
  ...
  <path fillRule="evenodd" d="M7.5 6a4.5 4.5 0 119 0 4.5 4.5 0 01-9 0zM3.751 20.105a8.25 8.25 0 0116.498 0 .75.75 0 01-.437.695A18.683 18.683 0 0112 22.5c-2.786 0-5.433-.608-7.812-1.7a.75.75 0 01-.437-.695z" clipRule="evenodd" />
          ...
          <button
          onClick={logout}
          className="text-sm bg-blue-300 py-1 px-2 rounded-sm text-gray-600">Logout</button>
          </div>
        </div>
        <div className="flex flex-col bg-blue-200 w-2/3 p-2">
            ...
            {!selectedUserId && (
              <div className="flex h-full items-center justify-center">
                <div className="text-gray-400">
                  &larr; Selected a person from the leftside
                </div>
          ...
          {!!selectedUserId && (
            <form className="flex gap-2" onSubmit={sendMessage}>
              ...
              />
              <label className="bg-gray-300 p-2 text-gray-400 rounded-sm border cursor-pointer border-gray-200">
